...
func TestCommitBlob(t *testing.T) {
	...
	for _, test := range testCases {
		...
		_ = os.Mkdir(persistentOutBlobDir, os.ModePerm)
	}
...
func TestCommitEvents(t *testing.T) {
	...
	for _, test := range testCases {
		...
		_ = os.Mkdir(persistentEventsDir, os.ModePerm)
...
func RefreshTempOutputs() {
	...
	_ = os.Mkdir(environment.OutputBlobDirPath, os.ModePerm)
	_ = os.Mkdir(environment.OutputEventsDirPath, os.ModePerm)
